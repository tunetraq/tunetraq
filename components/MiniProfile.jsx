        ...
        <div className="sticky top-14">
            <div className="flex items-center p-2 border-b">
                ...
                <div className="ml-2 flex-1">
                    ...
                    <p className="text-xs text-gray-400 font-semibold cursor-pointer">$0.00 - fan account</p>
                </div>
            ...
            <div className="border bg-white shadow-sm">
                ...
                <div className="uppercase mt-1 text-xs cursor-pointer text-center bg-blue-500 hover:bg-blue-400 hover:-translate-y-0.5 transform transition tracking-wider py-1 text-white font-semibold shadow-md">Get 20% off</div>
