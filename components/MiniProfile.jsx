        ...
        <div className="sticky top-14">
            ...
            <div className="border bg-white shadow-sm">
                ...
                <div className="flex items-center p-2">
                    ...
                    <div>
                        <p className="text-xs font-bold text-gray-800">Safaricom PLC</p>
                        <p className="text-xs text-gray-400">www.safaricom.co.ke</p>
                    </div>
                </div>
            </div>
                <div className="uppercase mt-1 text-xs cursor-pointer text-center bg-blue-500 py-1 text-white font-bold shadow-md">Get 20% off</div>
