...
function Tabs() {
    ...
    return (
        <div className="mt-7 ">
            <div className="flex items-center justify-center space-x-4 uppercase text-xs ">
                <div
                    onClick={() => toggleTab("LINKS")}
                 className={ activeTab === "LINKS" ? "flex px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-blue-500 font-bold transition-all duration-150 ease-in" : "flex font-bold px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-white"} >
                ...
                className={ activeTab === "LYRICS" ? "flex px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-blue-500 font-bold transition-all duration-150 ease-in" : "flex font-bold px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-white"}>
                ...
                className={ activeTab === "SKIZA" ? "flex px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-blue-500 font-bold transition-all duration-150 ease-in" : "flex font-bold px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-white"}>
                ...
                className={ activeTab === "STORE" ? "flex px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-blue-500 font-bold transition-all duration-150 ease-in" : "flex font-bold px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-white"}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                className={ activeTab === "TICKETS" ? " px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-blue-500 font-bold transition-all duration-150 ease-in" : "font-bold px-4 py-1 cursor-pointer text-gray-800 border-b-2 border-solid border-white"}>Tickets</div>
            </div>
        <div className="bg-gray-100">
            ...
            <div className={activeTab === "LINKS" ? "max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-2 lg:px-4 py-5 transition-all duration-150 ease-in" : "hidden"}>
                ...
                <div className="flex items-center rounded-lg bg-white shadow-lg overflow-hidden mb-3 cursor-pointer">
                    <img className="h-14 flex-shrink-0 object-cover"  src="/assets/thumb2.jpg" alt="product image"/>
                ...
                <div className="flex items-center rounded-lg bg-white shadow-lg overflow-hidden mb-3 cursor-pointer">
                    <img className="h-14 flex-shrink-0 object-cover"  src="/assets/thumb2.jpg" alt="product image"/>
                    <div className="flex-1">
                        <h3 className=" text-sm  text-gray-800 font-semibold px-2 line-clamp-2">Stream on Boomplay</h3>
                ...
                <div className="flex items-center rounded-lg bg-white shadow-lg overflow-hidden mb-3 cursor-pointer">
                    ...
                    <div className="flex-1 truncate">
                        <h3 className=" text-sm  text-gray-800 font-semibold px-2 line-clamp-2">Buy from Amazon Music</h3>
                ...
                <div className="flex items-center rounded-lg bg-white shadow-lg overflow-hidden mb-3 cursor-pointer">
                    <img className="h-14 flex-shrink-0 object-cover"  src="/assets/thumb2.jpg" alt="product image"/>
                    <div className="flex-1">
                        <h3 className=" text-sm  text-gray-800 font-semibold px-2 line-clamp-2">Buy from Apple Music</h3>
                ...
                <div className="flex items-center rounded-lg bg-white shadow-lg overflow-hidden mb-3 cursor-pointer">
                    <img className="h-14 flex-shrink-0 object-cover"  src="/assets/thumb2.jpg" alt="product image"/>
                    <div className="flex-1">
                        <h3 className=" text-sm  text-gray-800 font-semibold px-2 line-clamp-2">Watch on YouTube</h3>
