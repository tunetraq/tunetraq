        ...
        <div className="bg-white shadow-md border-b sticky top-0 z-50 py-2" >
            <nav className="flex justify-between items-center max-w-4xl mx-5 lg:mx-auto">
                ...
                <div className="flex items-center  bg-gray-100 py-1 px-2 rounded-2xl" >
                    ...
                    <div onClick={() => router.push('/')} className="ml-5 cursor-pointer hover:scale-125 transition-all duration-150 ease-out">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                        </svg>
                    </div>
                    <div className="relative ml-5 cursor-pointer hover:scale-125 transition-all duration-150 ease-out">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div className="ml-5 cursor-pointer hover:scale-125 transition-all duration-150 ease-out">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
